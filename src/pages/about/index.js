...
import ihealth0 from "./image/0ihealth.png";
import ihealth1 from "./image/1ihealth.png";
import ihealth2 from "./image/2ihealth.png";
import ihealth3 from "./image/3ihealth.png";
          ...
          <Row>
            <Col lg="10">
              <div className="po_item">
                <img src={ihealth0} alt="" />
                <div className="content">
                  <p>iHealth Homescreen</p>
            ...
            <Col lg="10">
              <div className="po_item">
                <img src={ihealth2} alt="" />
                <div className="content">
                  <p>iHealth Technology</p>
                  <a href="">view project</a>
                </div>
              </div>
            </Col>
            ...
            <Col lg="10">
              <div className="po_item">
                <img src={ihealth1} alt="" />
                <div className="content">
                  <p>iHealth Bottompage</p>
                  <a href="">view project</a>
                </div>
              </div>
            </Col>
